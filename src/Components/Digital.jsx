    ...
    <>
      ...
      <div className='big-container'>
        <div className="images-container">
          {photos.filter((item, index) => index % 3 === 0 && item.public_id.startsWith("digital")).map(photo => (
            <Image
              onClick={() => {
        ...
        <div className="images-container">
          {photos.filter((item, index) => index % 3 === 1 && item.public_id.startsWith("digital")).map(photo => (
            <Image
              onClick={() => {
                setSelectedPic(photo.url);
                setOpened(true);
        ...
        <div className="images-container">
          {photos.filter((item, index) => index % 3 === 2 && item.public_id.startsWith("digital")).map(photo => (
            <Image
              onClick={() => {
                setSelectedPic(photo.url);
                setOpened(true);
